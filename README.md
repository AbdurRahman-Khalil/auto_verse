# 🚗 AutoVerse: A Car Manufacturing Company

A clean, minimalistic and responsive landing page for a car manufacturing company(fictional), developed using only **HTML** and **CSS**.  
